...
var playGame = function playGame(spotRow, spotColumn, whoIs) {
...
var determineColor = function determineColor(spotRow, spotColumn, player) {
  if (typeof gameBoard[spotRow][spotColumn] === 'string') {} else if (player === playerOne) {
    return 'black';
...
var onClick1 = function onClick1() {
  var value = player;
  var index = 0;
  if (endGame === false && typeof gameBoard[0][0] !== 'string') {
    authApi.updateGame(index, value, endGame).then(authUi.updateSuccess).catch(authUi.updateFailure);
...
var onClick2 = function onClick2() {
  var value = player;
  var index = 1;
...
var onClick3 = function onClick3() {
  var value = player;
  var index = 2;
...
var onClick4 = function onClick4() {
  var value = player;
  var index = 3;
...
var onClick5 = function onClick5() {
  var value = player;
  var index = 4;
...
var onClick6 = function onClick6() {
  var value = player;
  var index = 5;
...
var onClick7 = function onClick7() {
  var value = player;
  var index = 6;
...
var onClick8 = function onClick8() {
  var value = player;
  var index = 7;
...
var onClick9 = function onClick9() {
  var value = player;
  var index = 8;
...
var onPlayAgain = function onPlayAgain(event) {
  ...
  authApi.newGame().then(authUi.newGameSuccess).catch(authUi.newGameFailure);
};
var onGetGame = function onGetGame(event) {
  event.preventDefault();
  authApi.getGame().then(authUi.getGameSuccess).catch(authUi.getGameFailure);
};
...
var updateGame = function updateGame(index, value, endGame) {
...
var newGameSuccess = function newGameSuccess(newGameResponse) {
  // console.log('You have started a new game', newGameResponse)
  store.game = newGameResponse.game;
};
var newGameFailure = function newGameFailure(newGameResponse) {
...
var updateFailure = function updateFailure(updateResponse) {
  // console.log('Failure is an option', updateResponse)
};
var getGameSuccess = function getGameSuccess(getResponse) {
  // console.log('get game is', getResponse)
  // $('#get-game-success').modal()
  $('#gameshow').html('Games played: ' + getResponse.games.length).show();
};
var getGameFailure = function getGameFailure(getResponse) {
